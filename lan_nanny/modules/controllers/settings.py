...
def save_general():
    ...
    _save_setting(conn, cursor, 'entities-per-page', request.form['setting_entities_per_page'])
...
def save_alerts():
    ...
    _save_setting(
        ...
        cursor,
        'alerts-new-device',
        request.form['setting_alert_new_device'])
    _save_setting(
        conn,
        cursor,
        'alerts-default-unidentified-online',
        request.form['setting_alert_unidentified_online_default'])
